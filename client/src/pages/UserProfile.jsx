...
function UserProfile() {
  ...
  useEffect(() => {
    ...
    getUser(); // Call the getUser function to execute the request
  }, []); // Add dependency array if needed, currently set to empty array
      ...
      <div className="container profile__container">
        ...
        <div className="profile__details">
          <div className="avatar__wrapper">
            ...
            {isAvatarTouched && <button className="profile__avatar-btn" onClick={changeAvatarHandle}>
              <FaCheck />
            </button>}
          </div>
